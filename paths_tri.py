...
# roots to store data
root_raw = "/home/ICT2000/rli/mnt/vgldb1/InfiniteRealities_Triplegangers/TrainingData/"
root_process = "/home/ICT2000/rli/mnt/glab2/ForRuilong/Triplegangers_process2/"
...
file_pointcloud_neutral_4k = osp(folder_pointcloud_4k, "*-*_01_*_pointcloud.exr")
file_albedo_neutral_4k = osp(folder_albedo_4k, "*-*_01_*_diffuse_albedo.exr")
...
file_pointcloud_neutral_ms = osp(folder_pointcloud_ms, "*-*_01_*_pointcloud.exr")
file_albedo_neutral_ms = osp(folder_albedo_ms, "*-*_01_*_diffuse_albedo.exr")
...
file_pointcloud_aug = osp(folder_pointcloud_aug, "*_*_01_blendshape_iter_*_pointcloud.exr")


file_gender_age = "./gender_age/Aligned_Point_Cloud_Neutral_TriplegangersData.xlsx"
    ...
    def get_files(self, index, aug=True):
        ...
        if aug and random.random() < 0.5:
            ...
            pointcloud_augs = glob.glob(osp(folder_pointcloud_aug, 
                                        f"{name}_blendshape_iter_*_pointcloud.exr"))
