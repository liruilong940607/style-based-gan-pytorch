...
file_pointcloud_4k = osp(folder_pointcloud_4k, "*_*_*_*_pointcloud.exr")
...
file_pointcloud_ms = osp(folder_pointcloud_ms, "*_*_*_*_pointcloud.exr")
...
file_exp_weights = osp(folder_exp_weights, "*_*_*_*_BSweights.mat")
