...
class MultiResolutionDataset(FWHDataset):
    ...
    def __getitem__(self, index):
        ...
        imgs_path = [os.path.join(self.root_geo.format(self.resolution), f"{name}_pointcloud.exr") for name in names]
        ...
        labels_path = [os.path.join(self.root_expw.format(self.resolution), f"{name}_BSweights.mat") for name in names]
