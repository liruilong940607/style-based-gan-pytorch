...
file_albedo_neutral_4k = osp(folder_albedo_4k, "*_*_01_diffuse_albedo.exr")
...
file_albedo_neutral_ms = osp(folder_albedo_ms, "*_*_01_diffuse_albedo.exr")
...
folder_albedo_aug = osp(root_raw, "AlbedoAugmentation")
file_pointcloud_aug = osp(folder_pointcloud_aug, "*-*_01_Neutral_blendshape_iter_*_pointcloud.exr")
file_albedo_aug = osp(folder_albedo_aug, "*_*_01_diffuse_albedo_*.exr")


file_gender_age = "./gender_age/Aligned_Point_Cloud_Neutral_LightStageData.xlsx"
